...
model = dict(
    ...
    use_grid_mask=True,
    video_test_mode=False,
    pretrained=dict(img='checkpoints/resnet50-19c8e357.pth'),
    img_backbone=dict(
        type='ResNet',
        depth=50,
        num_stages=4,
    ...
    pts_bbox_head=dict(
        ...
        transformer=dict(
            ...
            get_prior=get_prior,
            pretrain=False,
            pretrain_path='/home/zengshuang.zs/MEE-Pretrain/model23.pt',
            rotate_prev_bev=True,
            use_shift=True,
            use_can_bus=True,
            embed_dims=_dim_,
...
dataset_type = 'CustomNuScenesLocalMapDataset'
data_root = '/data/changxinyuan.cxy/NUSCENES/NUSCENES/'
file_client_args = dict(backend='disk')
