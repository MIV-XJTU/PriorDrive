...
class VectorizedLocalMap(object):
    ...
    def __init__(self,
        ...
        sd_map_path='./projects/mmdet3d_plugin/datasets/data_osm/osm'
    ...
    def gen_vectorized_samples(self, map_annotation,location, ego2global_translation, ego2global_rotation, example=None, feat_down_sample=32):
        '''
            ...
            if not line.is_empty:
                if line.geom_type == 'MultiLineString':
                    for single_line in line.geoms:
                        osm_vector_list.append(self.sample_fixed_pts_from_line(single_line, padding=False, fixed_num=20))
                elif line.geom_type == 'LineString':
                    osm_vector_list.append(self.sample_fixed_pts_from_line(line, padding=False, fixed_num=20))
                else:
        ...
        return anns_results,osm_vector_list
...
class CustomNuScenesOfflineLocalMapDataset(CustomNuScenesDataset):
    ...
    def __init__(self,
        ...
        self.nusc = NuScenes(version=self.version, dataroot=self.data_root,
                             verbose=False)
        self.scenes = self.get_scenes(self.version, not self.test_mode)
    ...
    def vectormap_pipeline(self, example, input_dict):
        ...
        anns_results,osm_vector_list = self.vector_map.gen_vectorized_samples(input_dict['annotation'] if 'annotation' in input_dict.keys() else input_dict['ann_info'],location,lidar2global_translation, lidar2global_rotation,
        ...
        example['trans'] = lidar2global_translation
        example['osm_vector']=DC(to_tensor(osm_vector_list),cpu_only=False)
        example['map_location']=DC(input_dict['map_location'],cpu_only=True)
